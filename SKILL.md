...
提取 Phase 4 的画像数据，反向推导对标筛选条件：

| 筛选维度 | 来源 |
|---------|------|
| 目标性别 | 用户画像性别分布 |
| 目标年龄 | 用户画像年龄分布 |
| 内容类型 | Phase 3 表现最好的 2-3 个类目 |
| 风格偏好 | Phase 3 表现最好类目的文章特征（干货/叙事/资讯？） |
| 活跃度 | 近 2 周内有发布 |

#### Step 2: 多轮关键词搜索

不要一次搜索就停下来。按以下策略执行多轮：

**第一轮：精准匹配**
搜索表现最好类目的精确关键词。比如 AI 实操类表现好，搜：
...
**第二轮：受众扩展**
基于真实受众的职业身份和痛点扩展关键词。比如 28-42 岁男性职场人 → 搜：

```
"AI一人公司" "独立开发者" "AI副业" "AI创业"
```
...
从搜索结果中提取潜在对标账号，按三类评分：

**五星对标（受众完美重叠）**

筛选条件：
- 内容主题与 Phase 3 表现最好的类目一致
- 内容风格与受众偏好一致（干货 vs 叙事 vs 资讯）
- 持续活跃

这类账号是核心对标对象，直接借鉴标题结构、选题节奏、内容深度。
